...
WEIXIN_APP_ID = os.environ.get('BKAPP_WEIXIN_APP_ID', 'wxb000e4299ddd85ac')
WEIXIN_APP_SECRET = os.environ.get('BKAPP_WEIXIN_APP_SECRET', '953e7237b18083f3415880fb38014124')
# 该蓝鲸应用对外暴露的外网域名，即配置的微信能回调或访问的域名，如：test.bking.com
WEIXIN_APP_EXTERNAL_HOST = os.environ.get('BKAPP_WEIXIN_APP_EXTERNAL_HOST', 'paas-class.bktencent.com')
# 应用授权作用域
